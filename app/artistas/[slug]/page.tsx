  ...
  return (
    <main>
      ...
      <section className="artist-profile-hero">
        ...
        <div>
          <p className="eyebrow">Artista · Ars Vita</p>
      ...
      <section className="artist-biography-section">
        <div className="artist-biography-inner">
          <p className="eyebrow">Biografía</p>
          <h2>Sobre {artist.name}</h2>

          <p className="artist-biography-text">
            {artist.bio}
          </p>
        </div>
      </section>
        ...
        {artist.artworks.length ? (
          <div className="public-work-grid">
            {artist.artworks.map((work) => (
              <article className="public-work-card" key={work.id}>
                ...
                <div>
                  ...
                  <p>
                    {[work.technique, work.dimensions, work.year]
                      .filter(Boolean)
                      .join(" · ")}
                  </p>
      ...
      <footer>
        <div className="footer-wordmark">
          ARS VITA <span>Creadores contemporáneos</span>
        </div>
